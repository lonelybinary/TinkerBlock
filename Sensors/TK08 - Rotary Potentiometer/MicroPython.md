...
This example shows how to use the TK08 - ROTARY POTENTIOMETER module on a Raspberry Pi Pico 2 to control LED brightness by rotating the potentiometer knob.
...
- **`pot.read_u16()`:** Read potentiometer analog value (0-65535), 0 means leftmost, 65535 means rightmost, 32768 means middle.
